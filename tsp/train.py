...
def train_instance(
    ...
    for pyg_data, distances in data:
        ...
        backward_flow = math.log(1 / (2 * pyg_data.x.shape[0])) - weighted_advantages.detach() * beta
...
if __name__ == "__main__":
    ...
    if args.beta_min is None:
        beta_min_map = {50: 100, 200: 200, 500: 200, 1000: 200 if args.pretrained is None else 1000}
        args.beta_min = beta_min_map[args.nodes]
    if args.beta_max is None:
        beta_max_map = {50: 500, 200: 1000, 500: 1000, 1000: 1000}
