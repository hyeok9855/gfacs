...
def test(dataset, model, n_ants, k_sparse, t_aco):
    ...
    for instance in tqdm(dataset, dynamic_ncols=True):
        results, diversities, elapsed_time = infer_instance(model, instance, n_ants, k_sparse, t_aco_diff)
...
if __name__ == "__main__":
    ...
    result_filename = f"test_result_ckpt{filename}-op{args.nodes}-ninst{args.size}-{ACOALG}-nants{args.n_ants}-niter{args.n_iter}-seed{args.seed}"
