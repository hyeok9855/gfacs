...
def train_instance(
    ...
    for pyg_data, demands, distances, positions in data:
        ...
        costs, log_probs, paths = aco.sample(invtemp=invtemp, epsilon=EPSILON)
...
if __name__ == "__main__":
    ...
    ### epsilon noise
    parser.add_argument("--epsilon", type=float, default=None, help='Epsilon noise for GFACS')
    ### GFACS
