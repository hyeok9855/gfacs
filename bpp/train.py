...
def train_instance(
    ...
    for _ in range(batch_size):
        ...
        if guided_exploration:
            ...
            backward_flow_ls = log_pb - advantages_ls.detach() * beta
...
def infer_instance(model, instance, n_ants):
    ...
    aco = ACO(demands, n_ants=n_ants, heuristic=heu_mat, use_local_search=True, device=DEVICE)
...
if __name__ == "__main__":
    ...
    if args.beta_min is None:
        beta_min_map = {120: 1000, 250: 2000, 500: 2000}
        args.beta_min = beta_min_map[args.nodes]
    if args.beta_max is None:
        beta_max_map = {120: 2000, 250: 5000, 500: 5000}
